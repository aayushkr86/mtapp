...
router.get('/branchactiveController/:id?', branch.findActive);
/*supervisior*/
 ...
 router.put('/controllerStatusfinalupdate/:id',controller.controllerStatusfinalupdate);
 router.get('/controllerchecker/:id',controller.controllerchecker);
 ...
 /*country*/
  ...
  router.get('/beneficiarybybranchController/:id',beneficiary.findbybranchAll);
   ...
   /* blacklist*/
   router.post('/blacklistController/:id',black.add);
...
router.put('/tellerStatusfinalupdate/:id',teller.tellerStatusfinalupdate);
router.get('/tellerchecker/:id',teller.tellerchecker);
router.get('/getallteller',teller.getallteller);
router.get('/getalltellerbybranch/:id',teller.getalltellerbybranch);
router.put('/updatelanguage/:id',teller.updatelanguage);
