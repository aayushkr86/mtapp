	...
	add: function(req,res){
     ...
     if(!req.body.branchID){
        return res.json({error : false , result : 'branchID can not be empty'});
           ...
           return res.json({error : false , result : 'Sendercomision can not be empty'});
         }
        else if(!req.body.platformcomsion){
            return res.json({error : false , result : 'Platformcomsion can not be empty'});
        }else if(!req.body.benefcomision){
           return res.json({error : false , result : 'Benefcomision can not be empty'});
         }else{
