app.controller('supervisorController',['$location','$timeout','$scope','$base64','$http','$window','$anchorScroll','$translate','$filter', function($location,$timeout,$scope,$base64,$http,$window,$anchorScroll,$translate,$filter){
    ...
    if($scope.tokendata.supervisiortype == 'Maker'){
       ...
       $(".checker").hide();
        ...
        $(".controllerchecker").hide();
         ...
         var notellerp = document.getElementById('notellerp');
         notellerp.style.display ="none";

         var notellerpage = document.getElementById('notellerpage');
         notellerpage.style.display ="block";

         var nocontroller = document.getElementById('nocontroller');
         nocontroller.style.display ="none";

         var nocontrollerpage = document.getElementById('nocontrollerpage');
         nocontrollerpage.style.display ="block";
     ...
     //  alert($scope.tokendata.supervisiortype);
      ...
      $(".controllerchecker").show();
       ...
       controllerconfirmation1.style.display = "block";
        ...
        var checkeredit = document.getElementById('checkeredit');
         checkeredit.style.display = "none";
         var checkerdelete = document.getElementById('checkerdelete');
         checkerdelete.style.display = "none";

         var searchtellerlistchecker = document.getElementById('searchtellerlistchecker');
         searchtellerlistchecker.style.display = "none";

         var checkerhr = document.getElementById('checkerhr');
         checkerhr.style.display = "none";

        var tellerform = document.getElementById('tellerform');
        tellerform.style.display = "none";
 ...
 /*==========get checker deatils=============*/
   $http({
         method: 'GET',
         url: '/tellerchecker/'+$scope.supervisorbranchID,
       }).success(function (response) {

        $scope.tellercheckerdetails = response.result;
        console.log('resultchecker',$scope.tellercheckerdetails);
        if($scope.tellercheckerdetails == ''){
          $(".tellertable").hide();
          // $('noteller').show();
          // $(".tellerpage").hide();
          var notellerp = document.getElementById('notellerp');
          notellerp.style.display = "block";

          var notellerpage = document.getElementById('notellerpage');
          notellerpage.style.display ="none"
        }else{
          $(".tellertable").show();
          // $(".noteller").hide();
          // $(".tellerpage").show();
...
$scope.confirmationMSg = function(tellerinfo){
  ...
  $http({
       ...
       $http({
             ...
             $scope.tellercheckerdetails = response.result.reverse();
             if($scope.tellercheckerdetails == ''){
               $(".tellertable").hide();
               var notellerp = document.getElementById('notellerp');
               notellerp.style.display = "block";
...
$scope.hideclearFiltersearchremiterlist = function(){
  var clearfiltersearchremiterlist = document.getElementById('clearfiltersearchremiterlist');
     clearfiltersearchremiterlist.style.display = "none";
};
$scope.searchremiterlist1;
$scope.searchremiterlistfilter = function(){
   $scope.searchremiterlist = encodeHtmlEntity(addslashes($scope.searchremiterlist1));
   var clearfiltersearchremiterlist1 = document.getElementById('clearfiltersearchremiterlist');
     clearfiltersearchremiterlist1.style.display = "block";
};
$scope.clearFiltersearchremiterlist = function(){
  $scope.searchremiterlist1 = null;
  $scope.searchremiterlist = null;
  var clearfiltersearchremiterlist2 = document.getElementById('clearfiltersearchremiterlist');
     clearfiltersearchremiterlist2.style.display = "none";
};
  ...
  $scope.clearFiltersearchtransactionlist = function(){
   ...
   var clearfiltersearchtransactionlist3 = document.getElementById('clearfiltersearchtransactionlist');
     clearfiltersearchtransactionlist3.style.display = "none";
  };
  ...
  $scope.hideclearFiltersearchcountrylimit = function(){
   ...
   $scope.clearFiltersearchcountrylimit = function(){
     $scope.searchcountrylimit1 = null;
      ...
      var clearfiltersearchcountrylimit3 = document.getElementById('clearfiltersearchcountrylimit');
     clearfiltersearchcountrylimit3.style.display = "none";
   };
...
$("html, body").animate({ scrollTop: 0 }, "slow");
 ...
 $scope.deleteCountry = function(country){
  ...
  /*end country*/
  /*==============================================================================*/
  $scope.hideclearFiltersearchcontrollerlist = function(){
    var clearfiltersearchcontrollerlist = document.getElementById('clearfiltersearchcontrollerlist');
     clearfiltersearchcontrollerlist.style.display = "none";

  };
  $scope.searchcontrollerlist1;
  $scope.searchcontrollerlistfilter = function(){
    $scope.searchcontrollerlist = encodeHtmlEntity(addslashes($scope.searchcontrollerlist1));
    var clearfiltersearchcontrollerlist1 = document.getElementById('clearfiltersearchcontrollerlist');
     clearfiltersearchcontrollerlist1.style.display = "block";
  };
  $scope.clearFiltersearchcontrollerlist = function(){
     $scope.searchcontrollerlist1 = null;
      $scope.searchcontrollerlist = null;
      var clearfiltersearchcontrollerlist3 = document.getElementById('clearfiltersearchcontrollerlist');
     clearfiltersearchcontrollerlist3.style.display = "none";
  ...
  $http({
       method: 'GET',
       url: '/controllerchecker/'+$scope.tokendata.branchID
       }).success(function (response) {
        $scope.controllerchecker = response.result.reverse();
        console.log('contcheck',$scope.controllerchecker);
        if($scope.controllerchecker == ''){
         $(".controllertable").hide();
         var nocontroller = document.getElementById('nocontroller');
         nocontroller.style.display = "block";
         var nocontrollerpage = document.getElementById('nocontrollerpage');
         nocontrollerpage.style.display = "none";

        }else{
           $(".controllertable").show();
           var nocontrollerpage = document.getElementById('nocontrollerpage');
           nocontrollerpage.style.display = "block";
           var nocontroller = document.getElementById('nocontroller');
           nocontroller.style.display = "none";
    ...
    if($scope.tokendata.supervisiortype == 'Maker'){
     ...
     //  alert($scope.tokendata.supervisiortype);
      ...
      $(".controllerchecker").show();
       ...
       var controllerconfirmation1 = document.getElementById('confirmationController');
       controllerconfirmation1.style.display = "block";
       var searchcontrollerlistchecker = document.getElementById('searchcontrollerlistchecker');
       searchcontrollerlistchecker.style.display = "none";
...
/*ranjitgorai*/
         ...
         url: '/controllerchecker/'+$scope.tokendata.branchID
           ...
           if($scope.controllerchecker == ''){
            ...
            nocontrollerpage.style.display = "none";
              ...
              controllertable.style.display = "display"
           }
              $(document).ready(function(){
                 $(".controllermaker").hide();
             });
  ...
  $scope.hideclearFiltersearchtariflist = function(){
    var clearfiltersearchtariflist = document.getElementById('clearfiltersearchtariflist');
     clearfiltersearchtariflist.style.display = "none";
   };
   $scope.searchtariflist1;
   $scope.searchtariflistfilter = function(){
    $scope.searchtariflist = encodeHtmlEntity(addslashes($scope.searchtariflist1));
    var clearfiltersearchtariflist1 = document.getElementById('clearfiltersearchtariflist');
     clearfiltersearchtariflist1.style.display = "block";
   };
   $scope.clearFiltersearchtariflist = function(){
    $scope.searchtariflist1 = null;
    $scope.searchtariflist = null;
    var clearfiltersearchtariflist3 = document.getElementById('clearfiltersearchtariflist');
     clearfiltersearchtariflist3.style.display = "none";
...
$scope.searchresult = function(){
  ...
  $http({
       method: 'GET',
       url: '/getalltellerbybranch/'+$scope.supervisorbranchID,
      headers: {'Content-Type': 'application/json'
       }
       }).success(function (response) {
...
$scope.searchingTransaction = function(){
  console.log('start',$scope.serachstartDate)
  console.log('end',$scope.serachendDate)
  ...
  $(".aftersearch").show();
   ...
   $scope.searchreportdata = {
     ...
     "branchID":$scope.supervisorbranchID,
...
console.log('report',$scope.searchreport)
