...
//   var clearFiltersearchsupervisorlist1 = document.getElementById('clearFiltersearchsupervisorlist1');
//   clearFiltersearchsupervisorlist1.style.display = "block";
// };

//   $scope.clearFiltersearchsupervisorlist = function(){
//       $scope.searchsupervisorlist1 = null;
//       $scope.searchsupervisorlist = null;
//       var clearFiltersearchsupervisorlist2 = document.getElementById('clearFiltersearchsupervisorlist');
//       clearFiltersearchsupervisorlist2.style.display = "none";
//   };
  /*==============================================================================*/ 
...
$scope.searchingTransaction = function(){
   ...
   $scope.searchreportdata = {
     ...
     "country":encodeHtmlEntity(addslashes($scope.serachcountry)),
