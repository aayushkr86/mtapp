app.controller('adminController',['$location','$timeout','$base64','$http','$window','$scope','$translate', '$filter', function($location,$timeout,$base64,$http,$window,$scope,$translate, $filter){
   ...
   if($scope.admindata == 'undefined' || $scope.admindata == '' || $scope.admindata == null){
    ...
    //   }
      ...
      $scope.branchpattern = /^[a-zA-Z,0-9]{1,20}$/;
      $scope.payementpattern = /^[0-9,]{1,100}$/;
      $scope.controllerpayementpattern = /^[0-9]{3,50}$/;
...
$scope.deleteBranch = function(branch){
  var deleteBranchconfirm = confirm("are you sure to delete branch?");
   ...
   /*get supervisior data from database*/
    ...
    $scope.cancelSupervisor = function(){
     ...
     $scope.deletesupervisor = function(superv){
      var deletesupervisorconfirm = confirm("are you sure to delete supervisior?");
...
$scope.deleteTeller = function(tellerid){
  var tellerdeleteconfirm = confirm("are you sure to delete teller?");
...
$scope.deleteController = function(control){
  var controllerdeleteconfirm = confirm("are you sure to delete controller?");
...
$("html, body").animate({ scrollTop: 0 }, "slow");
 ...
 $scope.deleteCountry = function(country){
  var deleteconfirmcountrylimt = confirm("are you sure to delete countrylimit?");
...
$scope.deleteTariff = function(tariff){
  var confirmdeleteTariffdata = confirm("are you sure to delete tariffdata?");
 ...
 $("html, body").animate({ scrollTop: 0 }, "slow");
      ...
      $scope.deleteComision = function(comision){
        var confirmdeletecomissiondata = confirm("are you sure to delete comissiondata?");
 ...
 console.log('suplierdata',$scope.suplierdata)
  ...
  $http({
    ...
    $scope.deleteSupplier = function(suplier){
      var deleteconfirmsupplierdata = confirm("are you sure to delete supplierdata?");
