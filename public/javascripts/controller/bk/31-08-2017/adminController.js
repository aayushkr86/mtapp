          ...
          ajax: function (data, callback, settings) {
            $.ajax({
              ...
              success:function(response){
                ...
                $scope.countrycurrencylist = JSON.stringify(response.result);
                alert($scope.countrycurrencylist);
              }

            });
            
          }
          //"deferLoading": $('#dtable445').DataTable().reload()
      } );
