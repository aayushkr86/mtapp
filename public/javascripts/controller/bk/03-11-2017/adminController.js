...
/*===========blacklist kyc ===================*/
//    $scope.blacklistshowhide = function(){

//   var deleteBlacklistbtn = document.getElementById('deleteBlacklistbtn');
//   deleteBlacklistbtn.style.display ="none";
//   var RemoveBlacklisthide = document.getElementById('RemoveBlacklisthide');
//   RemoveBlacklisthide.style.display ="none";
// };
// $scope.blacklistremoveshow = function(){
//   var deleteBlacklistbtn1 = document.getElementById('deleteBlacklistbtn');
//   deleteBlacklistbtn1.style.display ="block";
//   var RemoveBlacklisthide = document.getElementById('RemoveBlacklisthide');
//   RemoveBlacklisthide.style.display ="block";
// }


   $scope.blacklistadd = function(remit){
     $scope.rmdata ={
            "name":$scope.remittername,
            "surName":$scope.remittersurName
          };
    console.log('bdata',$scope.rmdata)
          $http({
               method: 'POST',
