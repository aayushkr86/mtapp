      ...
      $(".enableremit, .disableremit").unbind("click");
       $(document).on("click", ".enableremit, .disableremit", function(){
          ...
          $http({
            ...
            console.log('enabletodis',response);
          ...
          $this.removeClass("enableremit");
            ...
            $http({
              ...
              console.log('disabletoenalbe',response)
     ...
     $(".enablebenef, .disablebenef").unbind("click");
      $(document).on("click", ".enablebenef, .disablbenef", function(){
         ...
         $http({
          ...
          console.log('bebefresponse',response)

           console.log('benefkyc',response)
           if(response.data.message == 'Disalbe,paymentLimit exceed to countrylimit'){
             $this.text('Disable');
           }
           new PNotify({
               tittle : 'Regular notice',
...
$scope.deleteBranch = function(branch){
  var abc = confirm("are you sure to delete branch?");
  if(abc){
  $http({
            method: 'DELETE',
