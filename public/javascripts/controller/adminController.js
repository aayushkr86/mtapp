app.controller('adminController',['$location','$timeout','$base64','$http','$window','$scope','$translate', '$filter', function($location,$timeout,$base64,$http,$window,$scope,$translate, $filter){
   ...
   if($scope.admindata == 'undefined' || $scope.admindata == '' || $scope.admindata == null){
    ...
    //   }
      ...
      //aayush
      $scope.search = function(show,id,pattern) { 
      ...
      $(".enableremit, .disableremit").unbind("click");
       $(document).on("click", ".enableremit, .disableremit", function(){
          ...
          $http({
            ...
            if(response.data.message == 'paymentlimit exceed to countrylimit'){
              $this.text('Disable');
            }
            new PNotify({
                tittle : 'Regular notice',
          ...
          $this.removeClass("enableremit");
            ...
            $http({
              ...
              if(response.data.message == 'paymentlimit less than countrylimit'){
               $this.text('Enable');
              }
              new PNotify({
                  tittle : 'Regular notice',
...
$http({
   ...
   /*Branch*/
     ...
     $http({
         ...
         console.log('branchdata',$scope.branchdata4)
...
$scope.editBranch = function(branch){
  ...
  $scope.saveBranch = function() {
    // alert($scope.branchid);
     ...
     $scope.abc=$scope.arr.replace(/\s/g, '');//aayush
     //alert($scope.abc);
     $scope.paymentLimit = $scope.abc;
      ...
      "branchID":$scope.supbranchID
       ...
       $http({
            ...
            $scope.supervisioraddlimit = response.result;
             if($scope.supervisioraddlimit<4){
                ...
                console.log('superrecord',$scope.superRecord)
                    $http({
                         method: 'POST',
                         url: '/supervisiorController',
               ...
               new PNotify({
                  tittle : 'Regular notice',
                  type :'error',
                  text :"Four Supervisior for this branchID already added,You can't add more",
                });
             }//else
           }).error(function (response) {
            new PNotify({
...
$scope.$watch("supervisiorType", function(newValue, oldValue) {
    ...
    $scope.supersearchData = {
      ...
      $http({
          ...
          data: $scope.supersearchData,
            ...
            //console.log("Supervisor = "+JSON.stringify(response));
            $("label").addClass("active")
              $scope.tellersupervisorsel = $scope.getSupervisorData;
   ...
   $scope.resetTeller = function(){
     $scope.tellerbranch = "?";
     $scope.tellersupervisorsel = null;
   ...
   $http({
       ...
       headers: {'Content-Type': 'application/json'
        ...
        $scope.telleriddata = response.result.reverse();
         console.log('tellerid',$scope.telleriddata);
     ...
     $scope.editTeller = function(tellerid){
      ...
      $http({
           ...
           url: '/tellerID/'+tellerid._id,
            ...
            $("#tellersuperselect").css("display","none");
            $("#tellersuper").css("display","");
        ...
        $scope.updateTeller = function (){
          $("#tellersuper").show();
            ...
            //alert(JSON.stringify($scope.tellersupervisor));
          $scope.tellerlimit = $scope.arr1;
          ...
          $http({
               ...
               data: $scope.tellerupdateRecord,
                ...
                $("#tellersuperselect").css("display","");
            $("#tellersuper").css("display","none");
       ...
       "branchID":$scope.controllerBranch
        ...
        $http({
            ...
            headers: {'Content-Type': 'application/json'
             ...
             console.log('controllimit',$scope.controlleraddlimit);
  ...
  $("#currencyhide").hide();
     var btn21 = document.getElementById("addbtn4");
      ...
      $http({
        ...
        console.log('updatec',$scope.countryupdateRecord)
      $http({
           method: 'PUT',
           url: '/country/'+country._id,
       ...
       $scope.$watch("country", function(newValue, oldValue) {
              ...
              $scope.$watch("superCountry", function(newValue, oldValue) {
                     ...
                     $scope.$watch("tellerbranch", function(newValue, oldValue) {
                            ...
                            $scope.$watch("tellersupervisorsel", function(newValue, oldValue) {
                                       $timeout(function() {
